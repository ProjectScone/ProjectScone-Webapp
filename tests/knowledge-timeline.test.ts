...
const graph:Knowledge={space:'alpha',identity:JSON.stringify(['v','c','k','i','current-digest']),revision:1,mode:'current',asOf:'2026-06-01T00:00:00.000Z',entities:[],relations:[],attributes:[],analysis:null,inference:null,coverage:{truncated:false,reasons:[],counts:{}}};
