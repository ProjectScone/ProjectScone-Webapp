...
const graph:Knowledge={space:'alpha',identity:JSON.stringify(['v','c','k','i','d']),revision:1,mode:'current',asOf:'2026-09-11T12:00:00Z',entities:[],relations:[],attributes:[],analysis:null,inference:null,coverage:{truncated:false,reasons:[],counts:{}}};
